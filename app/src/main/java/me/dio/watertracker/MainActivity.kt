...
class MainActivity : AppCompatActivity() {
    ...
    private val prefs = GlassPreferences(this) /* this se refere ao context da aplicação */
    ...
    private fun refresh() {
        ...
        today = value
        findViewById<TextView>(R.id.txt_result).text = getString(R.string.result, today).lowercase()
